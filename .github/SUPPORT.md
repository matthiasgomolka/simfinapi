# Getting help with simfinapi

Thanks for using simfinapi. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/simfinapi/issues) to make sure the 
